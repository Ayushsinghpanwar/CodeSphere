...
const io = new Server(server, {
  cors: {
    origin: ["http://localhost:5173", "http://localhost:5174", "http://localhost:5175", "https://teamcodesphere.netlify.app"],
    methods: ["GET", "POST"],
    credentials: true,
  },
...
server.listen(PORT, async () => {
  ...
  console.log("🔌 Socket.IO CORS origins: localhost:5173, CodeSphere.netlify.app")
